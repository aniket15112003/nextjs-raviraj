...
const Indexx = ({ seminar }) => {
  ...
  return (
    <>
      ...
      <title>WORKSHOP &#8211; ravirajsabalepatil.onlinespe.com</title>
...
`}</style>
      ...
      <link rel='stylesheet' id='elementor-post-28-css' href='https://ravirajsabalepatil.onlinespe.com/wp-content/uploads/elementor/css/post-28.css?ver=1745299572' media='all' />
...
flexibility(document.documentElement);
      ...
      <link rel="https://api.w.org/" href="https://ravirajsabalepatil.onlinespe.com/wp-json/" /><link rel="alternate" title="JSON" type="application/json" href="https://ravirajsabalepatil.onlinespe.com/wp-json/wp/v2/pages/28" /><link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://ravirajsabalepatil.onlinespe.com/xmlrpc.php?rsd" />
      <meta name="generator" content="WordPress 6.7.2" />
      <link rel="canonical" href="https://ravirajsabalepatil.onlinespe.com/workshop/" />
      <link rel='shortlink' href='https://ravirajsabalepatil.onlinespe.com/?p=28' />
      <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="https://ravirajsabalepatil.onlinespe.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fravirajsabalepatil.onlinespe.com%2Fworkshop%2F" />
      <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="https://ravirajsabalepatil.onlinespe.com/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fravirajsabalepatil.onlinespe.com%2Fworkshop%2F&#038;format=xml" />
      ...
      <div className="hfeed site" id="page">
        ...
        <div id="content" className="site-content">
          <div className="ast-container">
            ...
            >
              <div
                className="elementor-element elementor-element-7fc625c e-flex e-con-boxed e-con e-parent"
                data-id="7fc625c"
              ...
              >
                <div className="e-con-inner">
                  <div
                    className="elementor-element elementor-element-c8761ba e-con-full e-flex e-con e-child"
                    data-id="c8761ba"
                    data-element_type="container"
                  >
                    <div
                      className="elementor-element elementor-element-f60f708 elementor-widget elementor-widget-heading"
                      data-id="f60f708"
              ...
              <div
                className="elementor-element elementor-element-1a1bcdf e-flex e-con-boxed e-con e-parent"
                data-id="1a1bcdf"
                data-element_type="container"
              >
                <div className="e-con-inner">
                  <div
                    className="elementor-element elementor-element-e8d1766 e-con-full e-flex e-con e-child"
                    data-id="e8d1766"
                    data-element_type="container"
                  >
                    <div
                      className="elementor-element elementor-element-6c45d53 elementor-grid-3 elementor-grid-tablet-2 elementor-grid-mobile-1 elementor-posts--thumbnail-top elementor-card-shadow-yes elementor-posts__hover-gradient elementor-widget elementor-widget-posts"
                      data-id="6c45d53"
                      data-element_type="widget"
                      ...
                      <div className="elementor-widget-container">
                        <div className="elementor-posts-container elementor-posts elementor-posts--skin-cards elementor-grid">
                          {Array.isArray(seminar) &&
                            seminar.map((sem, index) => (
                              <article key={index} className="elementor-post elementor-grid-item post-477 post type-post status-publish format-standard has-post-thumbnail hentry category-workshop">

                                <a
                                  className="elementor-post__thumbnail__link"
                                  href={`/workshop/Res/${encodeURIComponent(sem.title)}`}
                                  tabIndex={-1}
                                >
                                  <div>
                                    <img
                                      src={encodeURI(`${IMAGE_BASE_URL}${sem.photo}`)} // Prepend base URL and encode
                                      alt="Seminar"
                                      style={{
                                        width: "100%",
                                        maxWidth: "600px",
                                ...
                                <div className="elementor-post__text">
                                  <h3 className="elementor-post__title">
                                    <a href={`/workshop/Res/${encodeURIComponent(sem.title)}`}>
                                      {sem.title}
                                    </a>
                                  </h3>
                                  <a
                                    ...
                                    href={`/workshop/Res/${encodeURIComponent(sem.title)}`}
                                    aria-label={`Read more about ${sem.title}`}
                                    tabIndex={-1}
                                  >
                                    Register Now &gt;&gt;
                                  </a>
      ...
      {/* Page cached by LiteSpeed Cache 6.5.4 on 2025-04-22 07:02:56 */}
      ...
      {/* External JS assets */}
      {/* <Script
        src="https://ravirajsabalepatil.onlinespe.com/wp-content/themes/astra/assets/js/minified/frontend.min.js?ver=4.9.0"
...
wp.i18n.setLocaleData( { 'text direction\u0004ltr': [ 'ltr' ] } );
      ...
      <Script src="https://ravirajsabalepatil.onlinespe.com/wp-includes/js/imagesloaded.min.js?ver=5.0.0" id="imagesloaded-js"></Script>
...
export async function getServerSideProps() {
  ...
  try {
    ...
    return {
      props: { seminar }, // Correctly pass seminar as prop
    };
  } catch (error) {
    console.error("Error fetching seminar data:", error);
    return { props: { seminar: [] } }; // Handle errors by passing empty seminar data
  }
}
